 ...
 */
public class RectWaveform implements WaveformRender{
    ...
    private RectWaveform(int backgroundColor, Paint forgePaint, Path wavePath) {
        mBackgroundColor = backgroundColor;
        mForgePaint = forgePaint;
        mWavePath = wavePath;
    }

    public static RectWaveform newInstance(@ColorInt int backgroundColor, @ColorInt int foregroundColor){
        ...
        Path path = new Path();
        return new RectWaveform(backgroundColor, paint, path);
    }
